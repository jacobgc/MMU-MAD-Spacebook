...
import {
  Text, Box, Stack, Input, Button, Radio, Center, Heading, FlatList, HStack, VStack, Avatar, Spacer, ScrollView, Pressable,
} from 'native-base';
import React, { useEffect, useState } from 'react';
import AwesomeAlert from 'react-native-awesome-alerts';
import SpaceBookAPI from '../classes/SpaceBookAPI';
import AddFriendButton from '../components/addFriendButton';
import { AuthedRootNavigatorParams } from '../navigators/rootNavigator';
import { User } from '../types/user';
import getCurrentUser from '../utils/getCurrentUser';

type Props = DrawerScreenProps<AuthedRootNavigatorParams, 'Search'>;
